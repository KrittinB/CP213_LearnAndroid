...
import com.example.a157lablearnandroid.utiles.PokedexResponse
import com.example.a157lablearnandroid.utiles.PokemonEntry
import com.example.a157lablearnandroid.utiles.PokemonSpecies
import org.junit.Assert.*
import org.junit.Test

/**
 * Unit tests สำหรับ Data Model ของ Pokemon ทดสอบ Data Class: PokemonSpecies, PokemonEntry,
 * PokedexResponse
 */
class PokemonDataModelTest {
    ...
    fun pokedexResponse_findEntryByNumber_notFound() {
        val entries = listOf(PokemonEntry(1, PokemonSpecies("bulbasaur", "url1")))
        val response = PokedexResponse(pokemon_entries = entries)
